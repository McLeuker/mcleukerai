...
export function TopNavigation({ showSectorTabs = true, showCredits = true }: TopNavigationProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-black border-b border-border/30">
          ...
          {user ? (
            <>
              ...
              {showCredits && (
                <Link
                  to="/billing"
                  className="hidden sm:flex items-center gap-1.5 px-2.5 py-1.5 rounded-full bg-muted text-foreground hover:bg-muted/80 transition-colors"
                >
      ...
      {showTabs && (
        <div className="lg:hidden border-t border-border/30 px-4 py-2 overflow-x-auto bg-black">
