...
import { Leaf, ArrowRight, Check, Users } from "lucide-react";

const USE_CASES = [
  "Map certification requirements across target markets (EU, US, UK)",
  "Track regulatory changes impacting product compliance",
  "Analyze competitor sustainability claims and initiatives",
  "Benchmark environmental impact metrics against industry standards",
  "Research circular economy models and best practices",
  "Generate sustainability reports for stakeholder communications"
];
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-white/70 text-lg leading-relaxed">
              Navigate the complex landscape of sustainability certifications, regulations, 
              and best practices with AI-powered research and analysis.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto mb-16">
            <div className="bg-gradient-to-b from-[#1A1A1A] to-[#141414] rounded-2xl p-8 border border-white/[0.08]">
              ...
              <p className="text-white/60 leading-relaxed">
                Sustainability officers, compliance teams, CSR managers, and brand leaders 
                who need to understand and communicate environmental impact and progress.
              </p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {[
                "Certification mapping and requirements",
                "Regulatory compliance updates",
                "Impact measurement frameworks",
                "Competitor sustainability benchmarks",
